...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if(isNewGame) {
        ...
        // Шоон зургийг вэб дээр гаргаж ирнэ
        ...
        alert('Тоглоом дууссан байна. NEW GAME товчин дээр дарж эхлэн үү');
    }
});

// HOLD товчны эвент листенер
document.querySelector('.btn-hold').addEventListener('click', function() {
    // Уг тоглогчийн цуглуулсан ээлжийн оноог глобаль оноон дээр нь нэмж өгөн.
...
// Энэ фцнкц нь тоглох ээлжийг дараачийн тоглогч руу шилжүүлдэг.
...
function switchToNextPlayer() {
    ...
    // Улаан цэгийг шилжүүлэх (toggle: байвал хасна байхгүй бол нэмнэ.)
